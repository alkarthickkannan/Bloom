...
// import styles from './BannerViewWebPart.module.scss';
import  'jquery';
import pnp from 'sp-pnp-js'
import * as strings from 'BannerViewWebPartStrings';
import { readItems, checkUserinGroup } from '../../commonJS';

declare var $;
export interface IBannerViewWebPartProps {
  description: string;
}

export default class BannerViewWebPart extends BaseClientSideWebPart<IBannerViewWebPartProps> {
