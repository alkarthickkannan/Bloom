...
import styles from './EdmsProjectAnnouncementWebPart.module.scss';
import * as strings from 'EdmsProjectAnnouncementWebPartStrings';
import {readItems,checkUserinGroup} from '../../commonJS';

declare var $;

export interface IEdmsProjectAnnouncementWebPartProps {
  description: string;
}

export default class EdmsProjectAnnouncementWebPart extends BaseClientSideWebPart<IEdmsProjectAnnouncementWebPartProps> {
