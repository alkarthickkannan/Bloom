...
import styles from './EdmsHomepageTilesWebPart.module.scss';
import * as strings from 'EdmsHomepageTilesWebPartStrings';
import { addItems, readItems, deleteItem, updateItem  } from '../../commonJS';
declare var alertify:any;
export interface IEdmsHomepageTilesWebPartProps {
  description: string;
}

export default class EdmsHomepageTilesWebPart extends BaseClientSideWebPart<IEdmsHomepageTilesWebPartProps> {
