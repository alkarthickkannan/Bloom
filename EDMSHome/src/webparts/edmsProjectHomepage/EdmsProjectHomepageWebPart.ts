...
import styles from './EdmsProjectHomepageWebPart.module.scss';
import * as strings from 'EdmsProjectHomepageWebPartStrings';
import { addItems, readItems, deleteItem, updateItem  } from '../../commonJS';

export interface IEdmsProjectHomepageWebPartProps {
  description: string;
}
declare var alertify:any;
export default class EdmsProjectHomepageWebPart extends BaseClientSideWebPart<IEdmsProjectHomepageWebPartProps> {
